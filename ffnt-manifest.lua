-- $Id: ffnt-manifest.lua 10829 2025-02-20 02:21:40Z cfrees $
---------------------------------------------------------------------
---------------------------------------------------------------------
...
local fnttestfiles = fnt.testfiles or { fnt.regress, fnt.testtemp }
...
function manifest_setup ()
  ...
  if not direxists(testfiledir) then
    fnttestfiles = {} 
  elseif #filelist(testfiledir,"*.tlg") == 0 then
    fnttestfiles = {}
  end
  ...
  local groups = {
    ...
    },
    {
      ...
      exclude = {sourcefiles, typesetfiles, typesetsourcefiles, typesetdemofiles, fnttablestemplate, srclist,fntmklist,derlist,genlist},
    },
    {
