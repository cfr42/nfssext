...
\ProvidesFileSVN{$Id: fnt-tests.tex 10159 2024-07-15 08:04:28Z cfrees $}[v0.0 \revinfo][fnt-tests]
...
{%
  \iftctest\texttt{\textbackslash #2}\IfValueT{#1}{ (#1)}: \csname #2\endcsname\par\fi
}
\newif\iftctest
\fctesttrue
\makeatletter
